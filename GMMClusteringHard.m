...
% I3 = imresize(I3,[128 128]);
% I4 = imresize(I4,[128 128]);
...
gm = fitgmdist(X,4,'Options',options);
idx = cluster(gm,X);  
...
for iim2 = 1:(size(I1,1))
    for jjm2 = 1:(size(I1,2))
        if idx((iim2-1)*size(I1,2)+jjm2)==1 && ~(isnan(NDWI(iim2,jjm2)))
            cl1wvalue = double(cl1wvalue) + double(NDWI(iim2,jjm2));
            cl1wcount=cl1wcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==2 && ~(isnan(NDWI(iim2,jjm2)))
            cl2wvalue = double(cl2wvalue) + double(NDWI(iim2,jjm2));
            cl2wcount=cl2wcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==3 && ~(isnan(NDWI(iim2,jjm2)))
            cl3wvalue = double(cl3wvalue) + double(NDWI(iim2,jjm2));
            cl3wcount=cl3wcount+1;   
        
        elseif idx((iim2-1)*size(I1,2)+jjm2)==4 && ~(isnan(NDWI(iim2,jjm2)))
...
for iim2 = 1:(size(I1,1))
    for jjm2 = 1:(size(I1,2))
        if idx((iim2-1)*size(I1,2)+jjm2)==1 && ~(isnan(NDVI(iim2,jjm2)))
            cl1vvalue = double(cl1vvalue) + double(NDVI(iim2,jjm2));
            cl1vcount=cl1vcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==2 && ~(isnan(NDVI(iim2,jjm2)))
            cl2vvalue = double(cl2vvalue) + double(NDVI(iim2,jjm2));
            cl2vcount=cl2vcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==3 && ~(isnan(NDVI(iim2,jjm2)))
            cl3vvalue = double(cl3vvalue) + double(NDVI(iim2,jjm2));
            cl3vcount=cl3vcount+1;   
        
        elseif idx((iim2-1)*size(I1,2)+jjm2)==4 && ~(isnan(NDVI(iim2,jjm2)))
...
for iim2 = 1:(size(I1,1))
    for jjm2 = 1:(size(I1,2))
        if idx((iim2-1)*size(I1,2)+jjm2)==1 && ~(isnan(NDBI(iim2,jjm2)))
            cl1bvalue = double(cl1bvalue) + double(NDBI(iim2,jjm2));
            cl1bcount=cl1bcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==2 && ~(isnan(NDBI(iim2,jjm2)))
            cl2bvalue = double(cl2bvalue) + double(NDBI(iim2,jjm2));
            cl2bcount=cl2bcount+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==3 && ~(isnan(NDBI(iim2,jjm2)))
            cl3bvalue = double(cl3bvalue) + double(NDBI(iim2,jjm2));
            cl3bcount=cl3bcount+1;   
        
        elseif idx((iim2-1)*size(I1,2)+jjm2)==4 && ~(isnan(NDBI(iim2,jjm2)))
...
for iim = 1:(size(I1,1))
    for jjm = 1:(size(I1,2))
        ...
        elseif idx((iim-1)*size(I1,2)+jjm)==2
            if cluster2c == 0100
                climage(iim,jjm,1)=1.0;
        ...
        elseif idx((iim-1)*size(I1,2)+jjm)==3
            if cluster3c == 0100
                climage(iim,jjm,1)=1.0;
        ...
        elseif idx((iim-1)*size(I1,2)+jjm)==4
            if cluster4c == 0100
                climage(iim,jjm,1)=1.0;
...
for iim2 = 1:(size(I1,1))
    for jjm2 = 1:(size(I1,2))
        if idx((iim2-1)*size(I1,2)+jjm2)==1
        ...
        elseif idx((iim2-1)*size(I1,2)+jjm2)==2
            ...
            cl2n=cl2n+1;
        elseif idx((iim2-1)*size(I1,2)+jjm2)==3
        ...
        elseif idx((iim2-1)*size(I1,2)+jjm2)==4
